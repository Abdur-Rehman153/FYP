    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Aid-Hive, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Aid-Hive, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Aid-Hive is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2025-2026 Aid-Hive. All rights reserved.</p>
      </div>
    </div>
  );
}
